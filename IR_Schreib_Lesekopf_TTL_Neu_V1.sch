...
<deviceset name="1µF/10V" prefix="C">
<description>Keramik-Vielschicht-Kondensator 0,1µF, 50V</description>
<gates>
<gate name="G$1" symbol="1µF/10V" x="10.16" y="35.56"/>
</gates>
<devices>
...
<parts>
<part name="X4" library="TARGET3001!_V31.8.0.48" deviceset="GND" device="" value="GND"/>
<part name="X3" library="TARGET3001!_V31.8.0.48" deviceset="RXD" device="" value="RXD"/>
<part name="X1" library="TARGET3001!_V31.8.0.48" deviceset="+UB" device="" value="+Ub"/>
<part name="T1" library="TARGET3001!_V31.8.0.48" deviceset="SFH309FA-4" device="" value="SFH309FA-4"/>
<part name="R1" library="TARGET3001!_V31.8.0.48" deviceset="13K/1%" device="" value="13K/1%"/>
<part name="R4" library="TARGET3001!_V31.8.0.48" deviceset="13K/1%" device="" value="13K/1%"/>
<part name="C3" library="TARGET3001!_V31.8.0.48" deviceset="1µF/10V" device="" value="1µF/10V"/>
<part name="C1" library="TARGET3001!_V31.8.0.48" deviceset="1µF/10V" device="" value="1µF/10V"/>
<part name="D1" library="TARGET3001!_V31.8.0.48" deviceset="SFH487-2" device="" value="SFH487-2"/>
<part name="R3" library="TARGET3001!_V31.8.0.48" deviceset="13K/1%" device="" value="13K/1%"/>
<part name="X2" library="TARGET3001!_V31.8.0.48" deviceset="TXD" device="" value="TXD"/>
<part name="IC1" library="TARGET3001!_V31.8.0.48" deviceset="74LVC1G17DBVR" device="" value="74LVC1G17DBVR"/>
<part name="C2" library="TARGET3001!_V31.8.0.48" deviceset="1µF/10V" device="" value="1µF/10V"/>
<part name="IC2" library="TARGET3001!_V31.8.0.48" deviceset="74LVC1G17DBVR" device="" value="74LVC1G17DBVR"/>
<part name="D2" library="TARGET3001!_V31.8.0.48" deviceset="BAT46W" device="" value="BAT46W"/>
<part name="T3" library="TARGET3001!_V31.8.0.48" deviceset="BC817-40" device="" value="BC817-40"/>
<part name="R2" library="TARGET3001!_V31.8.0.48" deviceset="180R" device="" value="180R"/>
<part name="T2" library="TARGET3001!_V31.8.0.48" deviceset="BC807-40" device="" value="BC807-40"/>
</parts>
<sheets>
<sheet>
